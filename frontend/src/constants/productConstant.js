...
export const PRODUCT_NAME_REQUEST = "PRODUCT_NAME_REQUEST";
export const PRODUCT_NAME_SUCCESS = "PRODUCT_NAME_SUCCESS";
export const PRODUCT_NAME_FAIL = "PRODUCT_NAME_FAIL";
